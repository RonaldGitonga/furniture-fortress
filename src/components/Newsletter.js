//import newsletter message from DB
import {newsletter} from '@/data'

const Newsletter = () => {
//destructure newsletter info
const {title,subtitle,placeholder,buttonText}=newsletter


  return (<section id='Contact'className='section bg-newsletter min-h-[490px] bg-cover'>
    <div className="container mx-auto flex justify-center lg:justify-end ">
      <div className='w-full max-w-[558px] text-center text-white lg:text-left'>
        ...
        <div className='flex flex-col lg:flex-row gap-[22px]'>
          <input type="text"className='h-[60px] px-6 outline-none placeholder:text-gray-400 text-gray-600 rounded-lg 
          lg:flex-1' placeholder={placeholder}/>
